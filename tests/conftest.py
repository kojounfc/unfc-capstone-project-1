...
def sample_order_items():
    ...
    return pd.DataFrame({
        ...
        "created_at": pd.to_datetime(["2024-01-01", "2024-01-01", "2024-01-02", "2024-01-03", "2024-01-03"]),
        "shipped_at": pd.to_datetime(["2024-01-02", "2024-01-02", "2024-01-03", None, None]),
        "delivered_at": pd.to_datetime(["2024-01-04", "2024-01-04", "2024-01-05", None, None]),
...
def sample_merged_df(sample_order_items, sample_orders, sample_products, sample_users):
    ...
    df = pd.DataFrame({
        ...
        "category": ["Jeans", "Tops & Tees", "Jeans", "Outerwear & Coats", "Tops & Tees"],
        ...
        "item_delivered_at": pd.to_datetime(["2024-01-04", "2024-01-04", "2024-01-05", None, None]),
    })
    return df
